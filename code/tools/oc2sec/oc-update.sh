...
then
	...
	/bin/echo "	- padding_on, 0: off (recommended), 1: every section is padded, was useful with some buggy decoder, waste bandwidth, unsupported since OpenCaster 2.4.8, use one your own responsibility"
